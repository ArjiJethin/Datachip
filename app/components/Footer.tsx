  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-30 w-full h-[74px] bg-[#080913]/95 backdrop-blur-md border-t border-[#151728] text-[#cbd5e1] select-none">
      ...
      <div className="h-full max-w-7xl mx-auto flex items-center justify-between px-4 md:px-8">
        ...
        <div className="flex items-center justify-center gap-6 md:gap-10 lg:gap-14 mx-auto">
        ...
        {/* ================= 4. MUTE / AUDIO CONTROL BUTTON (RIGHT SIDE OF FOOTER) ================= */}
        <div className="flex items-center pl-2">
          ...
          >
            {isMuted ? (
              ...
              /* State 2: Unmuted & Active Audio / Playing Sound Waves */
